...
/* $Id: Smarty.class.php,v 1.2 2004/06/03 08:01:11 toolshed Exp $ */
 ...
 */
    ...
    function display($tpl_file, $cache_id = null, $compile_id = null)
    {
        ...
        $this->fetch ($config['LIBRARY_PATH'] . '/library_includes/smarty_templates/' . $tpl_file, $cache_id, $compile_id, true);
    }
    ...
    {        
        ...
        if($_compile_config) {
            ...
            if($_config_vars = array_merge($this->_conf_obj->get($file),
                ...
                touch($_compile_file,filemtime($LIBRARY_PATH . '/library_includes/smarty_conf/' . $_file_path));
            }
        }
   ...
   /**
    ...
    function _parse_file_path($file_base_path, $file_path, &$resource_type, &$resource_name)
    {
        ...
        if ($file_base_path == 'templates')
            $file_base_path = $LIBRARY_PATH . '/library_includes/smarty_templates/';
    ...
    function _get_auto_filename($auto_base, $auto_source = null, $auto_id = null)
    {
        ...
        if(@is_dir($auto_base)) {
            ...
            $res = $config['TEMP_PATH'] . '/smarty_cache/';
        }
