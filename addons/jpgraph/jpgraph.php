...
// Ver:		$Id: jpgraph.php,v 1.1 2003/06/11 04:48:08 toolshed Exp $
//
...
//
include 'addons/jpgraph/jpgraph_gradient.php';
...
class JpGraphErrObjectImg {
	...
	if( headers_sent($headers_file, $headers_line) ) {
	    ...
	    die("<b>JpGraph Error (Headers Sent Already $headers_file:$headers_line) :</b> ".$aMsg);		
	}
